...
public class Pirates extends EventCard {
    ...
    //  If the shot is small, the controller have to check the position of shields for each player, in case it have to ask the player if he wants to use the shield or not:
